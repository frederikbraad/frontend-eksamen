...
<body class="startpage-body">
    <div class="container">
        <div class="d-flex flex-row justify-content-center">
            ...
            <img src="images/RPS_logo1.png" id="margin-top" class="img-fluid" alt="Responsive image">
            </div>
        </div> 
            <div id="margin-top" class="d-flex flex-row justify-content-center">
            <div class="d-flex col-md-4">
                <h2 id="margin">Hi,<b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>! Welcome to my game site.</h1>
            </div>
            </div>
                <div class="d-flex flex-row justify-content-center">
                <div class="d-flex col-md-4">
